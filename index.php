      ...
      <div class="col-md-8">
       <div class="card">
        <div class="card-body text-center">
         ...
         <textarea rows="1" class="form-control text-center" style="width: 30%; float: right margin-bottom: 5px;" id="tgm" placeholder="insert id here"></textarea>
         </br>
      ...
      <div class="col-md-4">
       <div class="card mb-2">
        <div class="card-body">
         ...
         <hr>
         <h5>𝙇𝙄𝙑𝙀 : <span class="badge badge-success float-right aprovadas">0</span>
         </h5>
         <hr>
